# Contributing to UKIS-metrics

Welcome to `UKIS-metrics`. We invite anyone to participate by contributing code, reporting bugs, fixing bugs, writing documentation or discussing the future of this project. As a contributor, here are the guidelines we would like you to follow:
...
Help us keep `UKIS-metrics` open and inclusive. Please read and follow our [Code of Conduct](CODE_OF_CONDUCT.md).
